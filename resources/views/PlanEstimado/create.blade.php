    ...
    <div class="py-2">
        <div class=" ml-5">
            <h1 class="text-left text-xl font-medium ">
                Formulario de Planificación Estimada x Especie
            </h1>
        </div>
        <form action="{{ route('PlanEstimacion.store') }}" method="post">
            @CSRF
            ...
            <div class="grid xs:grid-cols-1 md:lg:xl:grid-cols-12 gap-3 p-5">
                ...
                <div class="col-span-4 text-left rounded-lg bg-white p-1 shadow-lg">
                    ...
                    <div class="">
                        <select class="text-neutral-900 p-2 border-2" id="empresa_id" name="empresa_id">
                ...
                <div class="col-span-4 text-left rounded-lg bg-white p-1 shadow-lg">
                    ...
                    <div class="">
                        <select class="text-neutral-900 p-2 border-2" id="campo_id" name="campo_id">
                        </select>
                        </h5>
                    </div>
                </div>
                ...
                <div class="col-span-4 text-left rounded-lg bg-white p-1 shadow-lg">
                    ...
                    <div class="">
                        <select class="text-neutral-900 p-2 border-2" id="cuartel_id" name="cuartel_id">
                        </select>
                        </h5>
                    </div>
                </div>
                ...
                <div class="text-left col-span-6 bg-white shadow-lg p-2 rounded-lg">
                    ...
                    <div class="mt-2 text-neutral-900">
                        <select name="responsable_id" class="text-neutral-900 border-2 p-2">
                            <option value=""><label
                ...
                <div class="text-left col-span-6 bg-white shadow-lg p-2 rounded-lg">
                    <div class="mt-2">
                        ...
                        <textarea id="about" name="observacion" rows="2"
                ...
                <div class="col-span-6 bg-white rounded-lg shadow-lg text-left p-2">
                    ...
                    <select name="especie_id" class="text-neutral-900  border-2 p-2" id="especie_id">
