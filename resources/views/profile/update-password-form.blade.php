<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('Actual Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('Nueva Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('Confirme nueva Password') }}" />
